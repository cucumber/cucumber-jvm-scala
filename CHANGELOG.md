...
- [Core] Update `cucumber-core` dependency to [7.34.7](https://github.com/cucumber/cucumber-jvm/blob/main/CHANGELOG.md)
...
- [Core] Update `cucumber-core` dependency to [7.34.6](https://github.com/cucumber/cucumber-jvm/blob/main/CHANGELOG.md)
...
- [Core] Update `cucumber-core` dependency to [7.32.0](https://github.com/cucumber/cucumber-jvm/blob/main/CHANGELOG.md)
- Upgrade Scala versions to 2.13.18
- [Scala] Test against Jackson 3.0.2
